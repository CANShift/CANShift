...
// Opened by a swipe-up gesture; closed by swiping back down.
// In simulation mode, values are generated by useLiveSignals.
// When connected to a device, values come from USB telemetry (TODO).
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ fontSize: fs - 1, color: '#666666' }}>swipe ↓ to close</span>
      </div>
