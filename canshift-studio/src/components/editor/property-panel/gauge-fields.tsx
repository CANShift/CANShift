          ...
          {GAUGE_STYLES.map(({ value, label }) => (
            <button
              ...
              style={{
                flex: 1,
                padding: '3px 0',
                background: style === value ? TILE_ACTIVE_BLUE_BG : PANEL_INPUT_BG,
                border: `1px solid ${style === value ? TILE_ACTIVE_BLUE_BORDER : PANEL_TILE_BORDER}`,
                borderRadius: 3,
                color: style === value ? TILE_ACTIVE_BLUE_FG : PANEL_TEXT_DIM,
                cursor: 'pointer',
                fontSize: 10,
            ...
            return (
              <button
                ...
                style={{
                  flex: 1,
                  padding: '3px 0',
                  background: isActive ? TILE_ACTIVE_GREEN_BG : PANEL_INPUT_BG,
                  border: `1px solid ${isActive ? TILE_ACTIVE_GREEN_BORDER : PANEL_TILE_BORDER}`,
                  borderRadius: 3,
                  color: isActive ? TILE_ACTIVE_GREEN_FG : PANEL_TEXT_DIM,
                  cursor: 'pointer',
                  fontSize: 10,
