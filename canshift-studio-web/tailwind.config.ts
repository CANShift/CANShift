// tailwind.config.ts — Mirrors canshift-studio/tailwind.config.ts so the
// dash-hosted spike consumes the same token surface as Electron Studio.
// Tokens flow from canshift-core (single source of truth, #906).
